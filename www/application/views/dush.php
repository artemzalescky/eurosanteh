...
?>
								...
								<div class="product">
									...
									<div class="product_image" style="height:170px;">
										<a href="/product?id_catalog=dush&id_product=<?=$item['id']?>"> 	
										<image src="/images/dush/<?=$item["photo_name"]?>.jpg"> </a>									
									</div>
									...
									<div class="product_buy" onClick="location.href='/cart?in_cart_catalog_id=dush&in_cart_product_id=<?=$item['id']?>'">
										В корзину
									</div>
